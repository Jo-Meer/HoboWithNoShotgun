...
uniform float red; // should be between 0 and 1
uniform float green; // should be between 0 and 1
uniform float blue; // should be between 0 and 1
...
void main()
{
	...
	vec3 myColor = vec3(red, green, blue);
